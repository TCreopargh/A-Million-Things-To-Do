package xyz.tcreopargh.amttd_web.api.exception

import com.google.gson.JsonParseException
import com.google.gson.JsonSyntaxException
import com.google.gson.stream.MalformedJsonException
import org.springframework.web.client.HttpStatusCodeException
import xyz.tcreopargh.amttd_web.api.exception.AmttdException.Companion.getFromException
...
class AmttdException(val errorCode: ErrorCode, val nestedException: Exception? = null) :
    ...
    enum class ErrorCode(val value: Int) {
        ...
        INSUFFICIENT_PERMISSION(41014),
        REQUESTED_ENTITY_INVALID(41015),
        UNIQUE_ID_CONFLICT(41016),
        ALREADY_IN_WORKGROUP(41017),
        CLIENT_NEEDS_UPDATE(41018),
        ...
        companion object {
            ...
            private val errorCodeMap: Map<Int, ErrorCode> = mutableMapOf<Int, ErrorCode>().apply {
            ...
            fun getFromErrorCode(errorCode: Int?): ErrorCode {
                return errorCodeMap[errorCode ?: return EXCEPTION_NOT_AVAILABLE] ?: UNKNOWN
            }
