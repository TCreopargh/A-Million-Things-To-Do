package xyz.tcreopargh.amttd.api.exception
...
import xyz.tcreopargh.amttd.api.exception.AmttdException.Companion.getFromException
...
class AmttdException(val errorCode: ErrorCode, val nestedException: Exception? = null) :
    ...
    enum class ErrorCode(val value: Int, @StringRes val localizedString: Int? = null) {
        ...
        CLIENT_NEEDS_UPDATE(41018, R.string.client_needs_update),
